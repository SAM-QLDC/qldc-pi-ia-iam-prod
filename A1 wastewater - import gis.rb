...
# Connection Nodes - from InfoAsset manhole
...
import_tables.push ImportTable.new('csv', 'node', 
	folder + data + '\wastewater_config.cfg', 
	folder + data + '\wwNodes.csv', 
	ImporterClassNode)
	
import_tables.push ImportTable.new('csv', 'pipe', 
	folder + data + '\wastewater_config.cfg', 
	folder + data + '\wwMain.csv', 
	ImporterClassPipe)

import_tables.push ImportTable.new('csv', 'connectionpipe', 
	folder + data + '\wastewater_config.cfg', 
	folder + data + '\wwLateral.csv', 
...
# Set up params
shp_options = Hash.new
shp_options['Duplication Behaviour'] = 'Merge'
shp_options['Default Value Flag'] = '#S'
shp_options['Set Value Flag'] = '#A'
shp_options['Error File'] = folder + data + '\errors_shp.txt'
...
net.odic_import_ex('shp',
	folder + data + '\wastewater_config.cfg', 
	shp_options, 'workpackage',
	folder + data + '\wwSchemes.shp')
	
# Do the import of water supply pressure zones
net.odic_import_ex('shp',
	folder + data + '\wastewater_config.cfg', 
	shp_options, 'treatmentworks',
	folder + data + '\wwTreatmentPlant.shp')
	
# Do the import of water supply pressure zones
net.odic_import_ex('shp',
	folder + data + '\wastewater_config.cfg', 
	shp_options, 'pumpstation',
	folder + data + '\wwPumpStation.shp')
