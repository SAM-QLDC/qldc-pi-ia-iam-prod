...
UPDATE IN SCENARIO 'AAA' SET system_type = 'sanitary' WHERE width_flag = $flag;
UPDATE IN SCENARIO 'AAO' SET system_type = 'sanitary' WHERE width_flag = $flag;
UPDATE IN SCENARIO 'AAV' SET system_type = 'sanitary' WHERE width_flag = $flag;
UPDATE IN SCENARIO 'AAW' SET system_type = 'sanitary' WHERE width_flag = $flag;
