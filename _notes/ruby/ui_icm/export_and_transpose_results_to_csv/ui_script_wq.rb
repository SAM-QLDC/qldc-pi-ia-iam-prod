...
# result types
#result_type = 'mch2s'           # concentration H2S dissolved (kg/m3)
result_type = 'MCbodDIS'         # concentration BOD dissolved (kg/m3)

#file_dir = WSApplication.folder_dialog 'Select a folder for results',  true
#file_name = file_dir + '\\' + 'project_x_' + result_type + '.csv'

file_dir = 'C:\\Users\\HLewis\\Downloads\\innovyze_ruby_scripts\\ui_icm_export csv with qm results\\'
file_name = file_dir + result_type + '.csv'
